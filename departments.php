                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            ...
                                            <div id="responsive" class="modal fade" tabindex="-1" data-width="560">
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal" method="post" action="assets/classes/controller.php?act=adddepartment">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                    try{
                                                        $query = $conn->prepare('SELECT * FROM company_departments WHERE companyId = ? AND active = ? ORDER BY departmentId DESC');
                                                        $fin = $query->execute([$_SESSION['companyid'], '1']);
                                                        $res = $query->fetchAll(PDO::FETCH_ASSOC);
                                                        //print_r($res);

                                                        foreach ($res as $row => $link) {
                                                            ?><tr class="odd gradeX"><td><input type="checkbox"></td> <?php echo '<td>' . $link['departmentId'] .  '</td><td>' . $link['companyDescription'] . '</td><td><a href="" class="btn btn-xs red"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td></tr>';
                                                        }
                                                    }
