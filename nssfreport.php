...
?>
                        ...
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> NSSF Report
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                                                        ...
                                                        foreach ($res as $row => $link) {
                                                            ?><tr class="odd gradeX"> 
                                                                <?php 
                                                                    ...
                                                                    echo '</td> <td>' . $link['empNssf'];
                                                                        
                                                                    echo '</td><td>'; 
                                                                         $typevar = $link['empNumber'];
                                                                        retrieveDescQuadFilter('employee_earnings_deductions', 'amount', $typevar, 'employeeId', 'earningDeductionCode', '482', 'companyId', $_SESSION['companyid'], 'payPeriod', $_SESSION['currentactiveperiod']);
