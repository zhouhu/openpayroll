...
?>
                        ...
                        <h1 class="page-title"> Dashboard
                            <small>overall snapshot of the organization</small>
                        </h1>
                        <!-- END PAGE TITLE-->
                        <!-- END PAGE HEADER-->
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span data-counter="counterup" data-value="<?php returnNumberOfEmployees() ;?>">0</span>
                                        </div>
                            ...
                            <!--<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                                    ...
                                    <div class="details">
                                        ...
                                        <div class="desc"> Employees left </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <a class="dashboard-stat dashboard-stat-v2 purple" href="#">
                                    ...
                                    <div class="details">
                                        <div class="number"> 
                                            <span data-counter="counterup" data-value="<?php echo $_SESSION['activeperiodDescription']; ?>"></span> </div>
                                        <div class="desc"> Current Pay Period </div>
                                    </div>
                                </a>
                            </div>
                        </div>
